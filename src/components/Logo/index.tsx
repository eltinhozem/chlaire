...
export type LogoProps = {
  color?: 'url(#dDourado)' | 'black' | 'white' // Pode ser degradê ou cor sólida
  size?: 'small' | 'medium' | 'large'
  hideOnMobile?: boolean
}

const Logo = ({ color = 'url(#dDourado)',
  size = 'medium',
  hideOnMobile = false
}: LogoProps) => (
  <S.Wrapper size={size} hideOnMobile={hideOnMobile}>
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 886.49 419.2">
      ...
      {/* Aplicando o preenchimento dinâmico com a prop `color` */}
      <path
        fill={color}
        stroke="none"
        strokeMiterlimit="10"
      ...
      <text
        ...
        fill={color}
        stroke="#000"
        fontFamily="TimesNewRomanPSMT,Times New Roman" // Corrigido para camelCase
        fontSize="140" // Corrigido para camelCase
